...
class TelegramEventObserver:
    ...
    def filter(self, *filters: CallbackType) -> None:
        """
        Register filter for all modules of this event observer
    ...
    async def trigger(self, event: TelegramObject, **kwargs: Any) -> Any:
        """
        Propagate event to modules and stops propagation on first match.
    ...
    def __call__(
        ...
        **kwargs: Any,
        ...
        """
        Decorator for registering event modules
        """
