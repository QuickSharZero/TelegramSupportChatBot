...
class Dispatcher(Router):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        :param kwargs: Other arguments, will be passed as keyword arguments to modules
        """
        ...
        # Error modules should work is out of all other functions
    ...
    async def _process_update(
        ...
        :param kwargs: contextual data for middlewares, filters and modules
        :return: status
        """
        try:
    ...
    async def start_polling(
        ...
        **kwargs: Any,
        ...
        :param backoff_config: backoff-retry config
        :param allowed_updates: List of the update types you want your bot to receive
               By default, all used update types are enabled (resolved from modules)
